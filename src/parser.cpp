...
int Parse::read_number_oct(const char **head)
{
	const char *str = *head;
...
int Parse::read_number_hex(const char **head)
{
	const char *str = *head;
	enum symbol_type type;
	int val = 0;
...
int Parse::read_number_float(const char **head)
{
	const char *str = *head;
	enum symbol_type type;
	int val = 0;
...
int Parse::read_number_dec(const char **head)
{
	const char *str = *head;
	enum symbol_type type;
	int val = 0;
...
int Parse::read_number_hex_or_oct(const char **head)
{
	const char *str = *head;
...
int Parse::read_number_signed(const char **head)
{
	const char *str = *head;
	enum symbol_type type = get_type_of_next_symbol(str[0]);
	int val;
